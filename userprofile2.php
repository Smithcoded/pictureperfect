...
<nav class="navbar navbar-fixed-top navbar-default" id = "#top">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li><a href="upload.php" id="flush1"><span class="glyphicon glyphicon-chevron-upload"></span> Upload Image</a></li>  
...
try {
			...
			$stmt=("SELECT imagepath, imagename, firstname, lastname  FROM images WHERE userid = :userid ORDER BY id DESC ");
			...
			if ($rows == 0) {
				echo  $noimage = " You have not uploaded any image yet";
			}
